...
osThreadId uart_to_can_task_handle;
...
void MX_FREERTOS_Init(void) {
  ...
  /* add threads, ... */
    ...
    osThreadDef(uart_to_can, uart_to_can_task, osPriorityNormal, 0, 128);
    uart_to_can_task_handle = osThreadCreate(osThread(uart_to_can), NULL);
#else
