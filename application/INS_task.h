...
// The original data of ist83100 is in the buf index of buffer
...
// The temperature of the mpu6500 is controlled by the CCR of timer, whose max value is MPU6500_TEMP_PWM_MAX - 1
#define MPU6500_TEMP_PWM_MAX 5000

// delay for some time before task starts
