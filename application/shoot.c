...
//     //电机指针
//     shoot_control.shoot_motor_measure = get_motor_measure_ptr_by_CAN_ID(CAN_TRIGGER_MOTOR_FEEDBACK_ID);
//     //初始化PID
...
//         switch (shoot_control.shoot_rc->rc.s[LEFT_LEVER_CHANNEL])
//         {
//         case RC_SW_UP:
//         {
//             if (last_s != RC_SW_UP)
...
//         }
//         }
//         last_s = shoot_control.shoot_rc->rc.s[LEFT_LEVER_CHANNEL];
//     }
// #endif
// }
// /**
...
//     //射击开关下档时间计时
//     if (shoot_control.shoot_mode != SHOOT_STOP && switch_is_down(shoot_control.shoot_rc->rc.s[LEFT_LEVER_CHANNEL]))
//     {
