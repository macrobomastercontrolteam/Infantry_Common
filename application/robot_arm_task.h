...
/*********** Robot Configs End ***********/
#define ARM_JOINT_0_ANGLE_STATIC   -0.01125335693359375f//0.12226295471191406f       
#define ARM_JOINT_1_ANGLE_STATIC -0.33258622884750366f//-0.12252672016620636f
#define ARM_JOINT_2_ANGLE_STATIC -1.5500414848327637f//-0.9702428579330444f
#define ARM_JOINT_3_ANGLE_STATIC 0.00286102294921875f //0.21572399139404297f
#define ARM_JOINT_4_ANGLE_STATIC -0.06275272369384766f //3.084038734436035f//0.0165939331054687f
#define ARM_JOINT_5_ANGLE_STATIC 0.80589454650878906f //1.5642404556274414f
#define ARM_JOINT_6_ANGLE_STATIC -0.219359263777f //-0.8927768468856f

#define ARM_JOINT_0_ANGLE_STORAGE -0.01125335693359375f//-0.032616615295410156//0.0f//2.077003479004f       
#define ARM_JOINT_1_ANGLE_STORAGE -0.2363216757774353f//-0.352f//-0.18379007279872894f
#define ARM_JOINT_2_ANGLE_STORAGE -0.37736653983592987f//-0.6691032648f//-0.975803554058075f
#define ARM_JOINT_3_ANGLE_STORAGE 0.9//0.00286102294921875f//1.3952465057373047f//1.167887687f//1.1385135650634766f
#define ARM_JOINT_4_ANGLE_STORAGE -0.06275272369384766f//-0.14095497131347656f//-0.077248f//-0.039864540100097656f
#define ARM_JOINT_5_ANGLE_STORAGE 0.9857553482055664f//0.94624996f//1.0049972534179688f
#define ARM_JOINT_6_ANGLE_STORAGE -0.219359263777f//-0.1089126393198967//-0.258475780487f//1.7625439167022705f
...
#define JOINT_0_ANGLE_PID_KP 5.0f
#define JOINT_0_ANGLE_PID_KI 0.0f
#define JOINT_0_ANGLE_PID_KD 0.0f
#define JOINT_0_ANGLE_PID_MAX_OUT RPM_TO_RADS(15.0f)
