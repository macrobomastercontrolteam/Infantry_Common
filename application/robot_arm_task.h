...
#define JOINT_0_ANGLE_PID_MAX_IOUT 0
...
#define JOINT_1_ANGLE_PID_MAX_IOUT 0

#define JOINT_2_ANGLE_PID_KP 20.0f
...
#define JOINT_3_ANGLE_PID_MAX_IOUT 0
...
#define JOINT_4_ANGLE_PID_MAX_IOUT 0
...
#define JOINT_5_ANGLE_PID_MAX_IOUT 0

#define JOINT_6_ANGLE_PID_KP 20.0f
#define JOINT_6_ANGLE_PID_KI 0.0f
#define JOINT_6_ANGLE_PID_KD 0.0f
#define JOINT_6_ANGLE_PID_MAX_OUT RPM_TO_RADS(25.0f)
#define JOINT_6_ANGLE_PID_MAX_IOUT 0

#define JOINT_0_SPEED_PID_KP 0.3f
#define JOINT_0_SPEED_PID_KI 0.0f
#define JOINT_0_SPEED_PID_KD 0.0f
#define JOINT_0_SPEED_PID_MAX_OUT 2.0f
#define JOINT_0_SPEED_PID_MAX_IOUT 0

#define JOINT_1_SPEED_PID_KP 0.6f
#define JOINT_1_SPEED_PID_KI 0.0f
#define JOINT_1_SPEED_PID_KD 0.0f
#define JOINT_1_SPEED_PID_MAX_OUT 3.0f
#define JOINT_1_SPEED_PID_MAX_IOUT 0

#define JOINT_2_SPEED_PID_KP 0.55f
#define JOINT_2_SPEED_PID_KI 0.0f
#define JOINT_2_SPEED_PID_KD 0.0f
#define JOINT_2_SPEED_PID_MAX_OUT 3.0f
#define JOINT_2_SPEED_PID_MAX_IOUT 0

#define JOINT_3_SPEED_PID_KP 55.0f
#define JOINT_3_SPEED_PID_KI 0.0f
#define JOINT_3_SPEED_PID_KD 0.0f
#define JOINT_3_SPEED_PID_MAX_OUT MOTOR_MG4005_MAX_CMD
#define JOINT_3_SPEED_PID_MAX_IOUT 0

#define JOINT_4_SPEED_PID_KP 90.0f
#define JOINT_4_SPEED_PID_KI 0.0f
#define JOINT_4_SPEED_PID_KD 0.0f
#define JOINT_4_SPEED_PID_MAX_OUT MOTOR_MS4005_MAX_CMD
#define JOINT_4_SPEED_PID_MAX_IOUT 0

#define JOINT_5_SPEED_PID_KP 75.0f
#define JOINT_5_SPEED_PID_KI 0.0f
#define JOINT_5_SPEED_PID_KD 0.0f
#define JOINT_5_SPEED_PID_MAX_OUT MOTOR_MS4005_MAX_CMD
#define JOINT_5_SPEED_PID_MAX_IOUT 0

#define JOINT_6_SPEED_PID_KP 65.0f
#define JOINT_6_SPEED_PID_KI 0.0f
#define JOINT_6_SPEED_PID_KD 0.0f
#define JOINT_6_SPEED_PID_MAX_OUT MOTOR_MS4005_MAX_CMD
#define JOINT_6_SPEED_PID_MAX_IOUT 0
...
#define JOINT_0_ANGLE_TEACH_PID_MAX_OUT RPM_TO_RADS(5.0f)
#define JOINT_0_ANGLE_TEACH_PID_MAX_IOUT 0

#define JOINT_1_ANGLE_TEACH_PID_KP 2.5f
#define JOINT_1_ANGLE_TEACH_PID_KI 0.0f
#define JOINT_1_ANGLE_TEACH_PID_KD 0.0f
#define JOINT_1_ANGLE_TEACH_PID_MAX_OUT RPM_TO_RADS(5.0f)
#define JOINT_1_ANGLE_TEACH_PID_MAX_IOUT 0

#define JOINT_2_ANGLE_TEACH_PID_KP 1.0f
#define JOINT_2_ANGLE_TEACH_PID_KI 0.0f
#define JOINT_2_ANGLE_TEACH_PID_KD 0.0f
#define JOINT_2_ANGLE_TEACH_PID_MAX_OUT RPM_TO_RADS(5.0f)
#define JOINT_2_ANGLE_TEACH_PID_MAX_IOUT 0

#define JOINT_3_ANGLE_TEACH_PID_KP 1.0f
#define JOINT_3_ANGLE_TEACH_PID_KI 0.0f
#define JOINT_3_ANGLE_TEACH_PID_KD 0.0f
#define JOINT_3_ANGLE_TEACH_PID_MAX_OUT RPM_TO_RADS(25.0f)
#define JOINT_3_ANGLE_TEACH_PID_MAX_IOUT 0

#define JOINT_4_ANGLE_TEACH_PID_KP 5.0f
#define JOINT_4_ANGLE_TEACH_PID_KI 0.0f
#define JOINT_4_ANGLE_TEACH_PID_KD 0.0f
#define JOINT_4_ANGLE_TEACH_PID_MAX_OUT RPM_TO_RADS(25.0f)
#define JOINT_4_ANGLE_TEACH_PID_MAX_IOUT 0

#define JOINT_5_ANGLE_TEACH_PID_KP 5.0f
#define JOINT_5_ANGLE_TEACH_PID_KI 0.0f
#define JOINT_5_ANGLE_TEACH_PID_KD 0.0f
#define JOINT_5_ANGLE_TEACH_PID_MAX_OUT RPM_TO_RADS(25.0f)
#define JOINT_5_ANGLE_TEACH_PID_MAX_IOUT 0

#define JOINT_6_ANGLE_TEACH_PID_KP 5.0f
#define JOINT_6_ANGLE_TEACH_PID_KI 0.0f
#define JOINT_6_ANGLE_TEACH_PID_KD 0.0f
#define JOINT_6_ANGLE_TEACH_PID_MAX_OUT RPM_TO_RADS(25.0f)
#define JOINT_6_ANGLE_TEACH_PID_MAX_IOUT 0

#define JOINT_0_SPEED_TEACH_PID_KP 0.1f
#define JOINT_0_SPEED_TEACH_PID_KI 0.0f
#define JOINT_0_SPEED_TEACH_PID_KD 0.0f
#define JOINT_0_SPEED_TEACH_PID_MAX_OUT 1.0f
#define JOINT_0_SPEED_TEACH_PID_MAX_IOUT 0

#define JOINT_1_SPEED_TEACH_PID_KP 0.6f
#define JOINT_1_SPEED_TEACH_PID_KI 0.0f
#define JOINT_1_SPEED_TEACH_PID_KD 0.0f
#define JOINT_1_SPEED_TEACH_PID_MAX_OUT 1.0f
#define JOINT_1_SPEED_TEACH_PID_MAX_IOUT 0

#define JOINT_2_SPEED_TEACH_PID_KP 0.2f
#define JOINT_2_SPEED_TEACH_PID_KI 0.0f
#define JOINT_2_SPEED_TEACH_PID_KD 0.0f
#define JOINT_2_SPEED_TEACH_PID_MAX_OUT 0.4f
#define JOINT_2_SPEED_TEACH_PID_MAX_IOUT 0

#define JOINT_3_SPEED_TEACH_PID_KP 55.0f
#define JOINT_3_SPEED_TEACH_PID_KI 0.0f
#define JOINT_3_SPEED_TEACH_PID_KD 0.0f
#define JOINT_3_SPEED_TEACH_PID_MAX_OUT MOTOR_MG4005_MAX_CMD
#define JOINT_3_SPEED_TEACH_PID_MAX_IOUT 0

#define JOINT_4_SPEED_TEACH_PID_KP 90.0f
#define JOINT_4_SPEED_TEACH_PID_KI 0.0f
#define JOINT_4_SPEED_TEACH_PID_KD 0.0f
#define JOINT_4_SPEED_TEACH_PID_MAX_OUT MOTOR_MS4005_MAX_CMD
#define JOINT_4_SPEED_TEACH_PID_MAX_IOUT 0

#define JOINT_5_SPEED_TEACH_PID_KP 85.0f
#define JOINT_5_SPEED_TEACH_PID_KI 0.0f
#define JOINT_5_SPEED_TEACH_PID_KD 0.0f
#define JOINT_5_SPEED_TEACH_PID_MAX_OUT MOTOR_MS4005_MAX_CMD
#define JOINT_5_SPEED_TEACH_PID_MAX_IOUT 0

#define JOINT_6_SPEED_TEACH_PID_KP 65.0f
#define JOINT_6_SPEED_TEACH_PID_KI 0.0f
#define JOINT_6_SPEED_TEACH_PID_KD 0.0f
#define JOINT_6_SPEED_TEACH_PID_MAX_OUT MOTOR_MS4005_MAX_CMD
#define JOINT_6_SPEED_TEACH_PID_MAX_IOUT 0
...
typedef struct
{
	...
	pid_type_def joint_speed_teach_pid[7];
