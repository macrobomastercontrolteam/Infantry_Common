...
#elif (ROBOT_TYPE == INFANTRY_2023_SWERVE) || (ROBOT_TYPE == INFANTRY_2024_MECANUM) || (ROBOT_TYPE == INFANTRY_2024_BIPED) || (ROBOT_TYPE == INFANTRY_2026_MECANUM) || (ROBOT_TYPE == INFANTRY_2026_STANDARD)
...
#elif (ROBOT_TYPE == INFANTRY_2024_MECANUM) || (ROBOT_TYPE == INFANTRY_2026_MECANUM) || (ROBOT_TYPE == INFANTRY_2026_STANDARD) //TODO: check speed compenstation for Inf_2026
#define SPEED_COMPENSATION_RATIO 1.22f
#elif (ROBOT_TYPE == HERO_2025_MECANUM)
...
#define HERO_FRICTON_MOTOR_JAM_RESOLVE_SPEED 6.0f //m/s

#define READY_TRIGGER_RATE 180.0f //ammo / minute
#define JAM_RESOLVE_TRIGGER_RATE 240.0f
...
#define JAM_RESOLVE_TRIGGER_SPEED     RPM_TO_RADS(TRIGGER_MOTOR_TO_WHEEL_GEAR_RATIO * JAM_RESOLVE_TRIGGER_RATE / TRIGGER_WHEEL_CAPACITY)
