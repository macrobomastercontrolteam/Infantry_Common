...
#elif (ROBOT_TYPE == INFANTRY_2023_SWERVE) || (ROBOT_TYPE == INFANTRY_2024_MECANUM) || (ROBOT_TYPE == INFANTRY_2024_BIPED) || (ROBOT_TYPE == INFANTRY_2026_MECANUM) //TODO: check trigger wheel pram for Inf_2026
...
#elif (ROBOT_TYPE == INFANTRY_2024_MECANUM) || (ROBOT_TYPE == INFANTRY_2026_MECANUM) //TODO: check speed compenstation for Inf_2026
#define SPEED_COMPENSATION_RATIO 1.22f
#elif (ROBOT_TYPE == HERO_2025_MECANUM)
