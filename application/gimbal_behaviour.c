...
//             !switch_is_down(gimbal_mode_set->gimbal_rc_ctrl->rc.s[LEFT_LEVER_CHANNEL]) && !toe_is_error(DBUS_TOE))
// #endif
//         {
//             return;
//         }
...
//         gimbal_behaviour = GIMBAL_ZERO_FORCE;
//     }
//     else if (switch_is_down(gimbal_mode_set->gimbal_rc_ctrl->rc.s[LEFT_LEVER_CHANNEL]))
//     {
//         gimbal_behaviour = GIMBAL_ZERO_FORCE;
//     }
//     else
...
//         if (switch_is_mid(gimbal_mode_set->gimbal_rc_ctrl->rc.s[LEFT_LEVER_CHANNEL]))
//         {
//             // corresponds to the mode CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW
//             gimbal_behaviour = GIMBAL_ABSOLUTE_ANGLE;
//         }
//         else if (switch_is_up(gimbal_mode_set->gimbal_rc_ctrl->rc.s[LEFT_LEVER_CHANNEL]))
//         {
// #if defined(SENTRY_1)
...
//     static int16_t JOYSTICK_LEFT_HORIZONTAL_CHANNEL = 0, JOYSTICK_LEFT_VERTICAL_CHANNEL = 0;

//     deadband_limit(gimbal_control_set->gimbal_rc_ctrl->rc.ch[JOYSTICK_LEFT_HORIZONTAL_CHANNEL], JOYSTICK_LEFT_HORIZONTAL_CHANNEL, RC_DEADBAND);
//     deadband_limit(gimbal_control_set->gimbal_rc_ctrl->rc.ch[JOYSTICK_LEFT_VERTICAL_CHANNEL], JOYSTICK_LEFT_VERTICAL_CHANNEL, RC_DEADBAND);

//     *yaw = JOYSTICK_LEFT_HORIZONTAL_CHANNEL * YAW_RC_SEN + gimbal_control_set->gimbal_rc_ctrl->mouse.x * YAW_MOUSE_SEN;
//     *pitch = JOYSTICK_LEFT_VERTICAL_CHANNEL * PITCH_RC_SEN + gimbal_control_set->gimbal_rc_ctrl->mouse.y * PITCH_MOUSE_SEN;
...
//     fp32 cv_JOYSTICK_LEFT_HORIZONTAL_CHANNEL = 0;
//     fp32 cv_JOYSTICK_LEFT_VERTICAL_CHANNEL = 0;
//     if (CvCmder_CheckAndResetFlag(&CvCmdHandler.fCvCmdValid))
//     {
//         deadband_limit(CvCmdHandler.CvCmdMsg.xDeltaAngle, cv_JOYSTICK_LEFT_HORIZONTAL_CHANNEL, CV_CAMERA_YAW_DEADBAND);
//         deadband_limit(CvCmdHandler.CvCmdMsg.yDeltaAngle, cv_JOYSTICK_LEFT_VERTICAL_CHANNEL, CV_CAMERA_PITCH_DEADBAND);
//     }
//     *yaw = moving_average_calc(cv_JOYSTICK_LEFT_HORIZONTAL_CHANNEL, &(gimbal_control_set->gimbal_yaw_motor.CvCmdAngleFilter), MOVING_AVERAGE_CALC);
//     *pitch = moving_average_calc(cv_JOYSTICK_LEFT_VERTICAL_CHANNEL, &(gimbal_control_set->gimbal_pitch_motor.CvCmdAngleFilter), MOVING_AVERAGE_CALC);
// }
