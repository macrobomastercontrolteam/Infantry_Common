...
#define SPINNING_CHASSIS_RANDOM_OMEGA_MIN SPINNING_CHASSIS_LOW_OMEGA
...
#define MOUSE_SCROLL_TO_DIAL_SEN_INC -(JOYSTICK_HALF_RANGE / MOUSE_X_EFFECTIVE_SPEED * 152)
