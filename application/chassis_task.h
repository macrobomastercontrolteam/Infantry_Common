...
#define CHASSIS_ACCEL_X_NUM 6.0f
#define CHASSIS_ACCEL_Y_NUM 6.0f
#define CHASSIS_SPIN_ACCEL_X_NUM 6.0f
#define CHASSIS_SPIN_ACCEL_Y_NUM 6.0f
// gentler ramp used when reversing direction, so the wheels brake/re-accelerate gradually and bound the power spike
#define CHASSIS_REVERSAL_ACCEL_X_NUM 1.5f
#define CHASSIS_REVERSAL_ACCEL_Y_NUM 1.5f
...
#define MOTOR_DISTANCE_TO_CENTER_DEFAULT 0.24f
#elif (ROBOT_TYPE == INFANTRY_2024_BIPED)
