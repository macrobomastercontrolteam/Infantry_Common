...
#define CHASSIS_WHEEL_REDIUS 0.0785f
...
#define CHASSIS_THETA_LOWER_LIMIT_ECD (CHASSIS_THETA_LOWER_LIMIT * DM4340_MOTOR_RAD_TO_ECD)
#define CHASSIS_THETA_UPPER_LIMIT_ECD (CHASSIS_THETA_UPPER_LIMIT * DM4340_MOTOR_RAD_TO_ECD)
#endif
