...
#define SPINNING_CHASSIS_ULTRA_LOW_OMEGA RPM_TO_RADS(10.0f)
#define SPINNING_CHASSIS_LOW_OMEGA RPM_TO_RADS(35.0f)
#define SPINNING_CHASSIS_MED_OMEGA RPM_TO_RADS(40.0f)
#define SPINNING_CHASSIS_HIGH_OMEGA RPM_TO_RADS(50.0f)
