...
#define CHASSIS_ROLL_RC_CHANGE_TIME_S 2.0f
#define CHASSIS_ROLL_KEYBOARD_INC (MAX_CHASSIS_ROLL / CHASSIS_ROLL_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S)
#define CHASSIS_ROLL_RC_SEN_INC (MAX_CHASSIS_ROLL / CHASSIS_ROLL_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S / JOYSTICK_FULL_RANGE)
