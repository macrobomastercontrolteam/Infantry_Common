...
#define GIMBAL_JOINT_0_ANGLE_RANGE (GIMBAL_JOINT_0_ANGLE_MAX-GIMBAL_JOINT_0_ANGLE_MIN)
#define GIMBAL_JOINT_0_ANGLE_REST 0.0f
#define GIMBAL_JOINT_0_RC_SEN (JOINT_0_RC_DIRECTION_GAIN * GIMBAL_JOINT_0_ANGLE_RANGE / JOYSTICK_FULL_RANGE)
#define GIMBAL_JOINT_0_ANGLE_RC_CHANGE_TIME_S 3.0f
#define GIMBAL_JOINT_0_KEYBOARD_INC (JOINT_0_RC_DIRECTION_GAIN * GIMBAL_JOINT_0_ANGLE_RANGE / GIMBAL_JOINT_0_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S)
#define GIMBAL_JOINT_0_RC_SEN_INC (JOINT_0_RC_DIRECTION_GAIN * GIMBAL_JOINT_0_ANGLE_RANGE / GIMBAL_JOINT_0_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S / JOYSTICK_HALF_RANGE)

#define GIMBAL_JOINT_1_ANGLE_MIN (-30.0f / 180.0f * PI)
#define GIMBAL_JOINT_1_ANGLE_MAX (35.0f / 180.0f * PI)
#define GIMBAL_JOINT_1_ANGLE_RANGE (GIMBAL_JOINT_1_ANGLE_MAX-GIMBAL_JOINT_1_ANGLE_MIN)
#define GIMBAL_JOINT_1_ANGLE_REST GIMBAL_JOINT_1_ANGLE_MAX
#define GIMBAL_JOINT_1_RC_SEN (JOINT_1_RC_DIRECTION_GAIN * GIMBAL_JOINT_1_ANGLE_RANGE / JOYSTICK_HALF_RANGE)
#define GIMBAL_JOINT_1_ANGLE_RC_CHANGE_TIME_S 1.0f
#define GIMBAL_JOINT_1_KEYBOARD_INC (JOINT_1_RC_DIRECTION_GAIN * GIMBAL_JOINT_1_ANGLE_RANGE / GIMBAL_JOINT_1_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S)
#define GIMBAL_JOINT_1_RC_SEN_INC (JOINT_1_RC_DIRECTION_GAIN * GIMBAL_JOINT_1_ANGLE_RANGE / GIMBAL_JOINT_1_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S / JOYSTICK_HALF_RANGE)

#define GIMBAL_JOINT_2_ANGLE_MIN (-150.0f / 180.0f * PI)
#define GIMBAL_JOINT_2_ANGLE_MAX 0.0f
#define GIMBAL_JOINT_2_ANGLE_RANGE (GIMBAL_JOINT_2_ANGLE_MAX-GIMBAL_JOINT_2_ANGLE_MIN)
#define GIMBAL_JOINT_2_ANGLE_REST GIMBAL_JOINT_2_ANGLE_MIN
#define GIMBAL_JOINT_2_RC_SEN (JOINT_2_RC_DIRECTION_GAIN * GIMBAL_JOINT_2_ANGLE_RANGE / JOYSTICK_HALF_RANGE)
#define GIMBAL_JOINT_2_ANGLE_RC_CHANGE_TIME_S 1.5f
#define GIMBAL_JOINT_2_KEYBOARD_INC (JOINT_2_RC_DIRECTION_GAIN * GIMBAL_JOINT_2_ANGLE_RANGE / GIMBAL_JOINT_2_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S)
#define GIMBAL_JOINT_2_RC_SEN_INC (JOINT_2_RC_DIRECTION_GAIN * GIMBAL_JOINT_2_ANGLE_RANGE / GIMBAL_JOINT_2_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S / JOYSTICK_HALF_RANGE)

#define GIMBAL_JOINT_3_ANGLE_MIN (-80.0f / 180.0f * PI)
#define GIMBAL_JOINT_3_ANGLE_MAX (80.0f / 180.0f * PI)
#define GIMBAL_JOINT_3_ANGLE_RANGE (GIMBAL_JOINT_3_ANGLE_MAX-GIMBAL_JOINT_3_ANGLE_MIN)
#define GIMBAL_JOINT_3_ANGLE_REST 0.0f
#define GIMBAL_JOINT_3_RC_SEN (JOINT_3_RC_DIRECTION_GAIN * GIMBAL_JOINT_3_ANGLE_RANGE / JOYSTICK_FULL_RANGE)
#define GIMBAL_JOINT_3_ANGLE_RC_CHANGE_TIME_S 1.0f
#define GIMBAL_JOINT_3_KEYBOARD_INC (JOINT_3_RC_DIRECTION_GAIN * GIMBAL_JOINT_3_ANGLE_RANGE / GIMBAL_JOINT_3_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S)
#define GIMBAL_JOINT_3_RC_SEN_INC (JOINT_3_RC_DIRECTION_GAIN * GIMBAL_JOINT_3_ANGLE_RANGE / GIMBAL_JOINT_3_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S / JOYSTICK_HALF_RANGE)

#define GIMBAL_JOINT_4_ANGLE_MIN (-0.5f * PI)
#define GIMBAL_JOINT_4_ANGLE_MAX (0.5f * PI)
#define GIMBAL_JOINT_4_ANGLE_RANGE (GIMBAL_JOINT_4_ANGLE_MAX-GIMBAL_JOINT_4_ANGLE_MIN)
#define GIMBAL_JOINT_4_ANGLE_REST 0.0f
#define GIMBAL_JOINT_4_RC_SEN (JOINT_4_RC_DIRECTION_GAIN * GIMBAL_JOINT_4_ANGLE_RANGE / JOYSTICK_FULL_RANGE)
#define GIMBAL_JOINT_4_ANGLE_RC_CHANGE_TIME_S 1.0f
#define GIMBAL_JOINT_4_KEYBOARD_INC (JOINT_4_RC_DIRECTION_GAIN * GIMBAL_JOINT_4_ANGLE_RANGE / GIMBAL_JOINT_4_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S)
#define GIMBAL_JOINT_4_RC_SEN_INC (JOINT_4_RC_DIRECTION_GAIN * GIMBAL_JOINT_4_ANGLE_RANGE / GIMBAL_JOINT_4_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S / JOYSTICK_HALF_RANGE)

#define GIMBAL_JOINT_5_ANGLE_MIN (10.0f / 180.0f * PI)
#define GIMBAL_JOINT_5_ANGLE_MAX (170.0f / 180.0f * PI)
#define GIMBAL_JOINT_5_ANGLE_RANGE (GIMBAL_JOINT_5_ANGLE_MAX-GIMBAL_JOINT_5_ANGLE_MIN)
#define GIMBAL_JOINT_5_ANGLE_REST GIMBAL_JOINT_5_ANGLE_MAX
#define GIMBAL_JOINT_5_RC_SEN (JOINT_5_RC_DIRECTION_GAIN * GIMBAL_JOINT_5_ANGLE_RANGE / JOYSTICK_FULL_RANGE)
#define GIMBAL_JOINT_5_ANGLE_RC_CHANGE_TIME_S 1.0f
#define GIMBAL_JOINT_5_KEYBOARD_INC (JOINT_5_RC_DIRECTION_GAIN * GIMBAL_JOINT_5_ANGLE_RANGE / GIMBAL_JOINT_5_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S)
#define GIMBAL_JOINT_5_RC_SEN_INC (JOINT_5_RC_DIRECTION_GAIN * GIMBAL_JOINT_5_ANGLE_RANGE / GIMBAL_JOINT_5_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S / JOYSTICK_HALF_RANGE)

#define GIMBAL_JOINT_6_ANGLE_MIN (-PI)
#define GIMBAL_JOINT_6_ANGLE_MAX PI
#define GIMBAL_JOINT_6_ANGLE_RANGE (GIMBAL_JOINT_6_ANGLE_MAX-GIMBAL_JOINT_6_ANGLE_MIN)
#define GIMBAL_JOINT_6_ANGLE_REST 0.0f
#define GIMBAL_JOINT_6_RC_SEN (JOINT_6_RC_DIRECTION_GAIN * GIMBAL_JOINT_6_ANGLE_RANGE / JOYSTICK_FULL_RANGE)
#define GIMBAL_JOINT_6_ANGLE_RC_CHANGE_TIME_S 1.0f
#define GIMBAL_JOINT_6_KEYBOARD_INC (JOINT_6_RC_DIRECTION_GAIN * GIMBAL_JOINT_6_ANGLE_RANGE / GIMBAL_JOINT_6_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S)
#define GIMBAL_JOINT_6_RC_SEN_INC (JOINT_6_RC_DIRECTION_GAIN * GIMBAL_JOINT_6_ANGLE_RANGE / GIMBAL_JOINT_6_ANGLE_RC_CHANGE_TIME_S * CHASSIS_CONTROL_TIME_S / JOYSTICK_HALF_RANGE)
