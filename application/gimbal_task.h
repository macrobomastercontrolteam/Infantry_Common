...
#define PITCH_ANGLE_PID_KI 15.0f
#define PITCH_ANGLE_PID_KD 0.0f
#define PITCH_ANGLE_PID_MAX_OUT 10.0f
...
#if PITCH_IS_4310
#define PITCH_CAMERA_ANGLE_PID_KP 20.0f
#define PITCH_CAMERA_ANGLE_PID_KI 15.0f
#define PITCH_CAMERA_ANGLE_PID_KD 0.0f
#define PITCH_CAMERA_ANGLE_PID_MAX_OUT 10.0f
#define PITCH_CAMERA_ANGLE_PID_MAX_IOUT 15.0f
#endif
...
#define YAW_CV_SEN_INC (PI / 100.0f)
#define PITCH_CV_SEN_INC (3.0f * PI / 500.0f)
