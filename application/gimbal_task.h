...
#if (ROBOT_TYPE == INFANTRY_2023_MECANUM) || (ROBOT_TYPE == INFANTRY_2024_MECANUM) || (ROBOT_TYPE == SENTRY_2023_MECANUM) || (ROBOT_TYPE == INFANTRY_2026_MECANUM) || (ROBOT_TYPE == SENTRY_2026_OMNI) //TODO: check if PITCH_REVERSED for Inf_2026 || (ROBOT_TYPE == SENTRY_2026_OMNI)
