...
#define PITCH_CAMERA_SPEED_PID_KP 15.0f
#define PITCH_CAMERA_SPEED_PID_KI 0.0f
#define PITCH_CAMERA_SPEED_PID_KD 0.0f
#define PITCH_CAMERA_SPEED_PID_MAX_OUT 30.0f
#define PITCH_CAMERA_SPEED_PID_MAX_IOUT 10.0f
...
#define PITCH_CAMERA_ANGLE_PID_KP 5.0f
...
#define PITCH_RC_SEN_INC -(PI / 20.0f / PITCH_RC_CHANGE_TIME_S * GIMBAL_CONTROL_TIME_S / JOYSTICK_HALF_RANGE)//((PI / 18.0f)  / JOYSTICK_HALF_RANGE)
#define PITCH_RC_MOUSE_SEN_INC (PI / 4.0f / PITCH_RC_CHANGE_TIME_S * GIMBAL_CONTROL_TIME_S / MOUSE_Y_EFFECTIVE_SPEED)
#define PITCH_RC_KEY_SEN_INC (PI / 1800.0f) 
