...
fp32 vtm_yaw_error_dot_filter_coeff = 0.75f;
void vtm_gimbal_control(void)
{
	...
	if (fLastVtmGimbalPowerEnabled != vtm_gimbal.fVtmGimbalPowerEnabled)
	{
		...
		{
			motor_measure[MOTOR_INDEX_VTM_YAW].offset_ecd = motor_measure[MOTOR_INDEX_VTM_YAW].ecd;
			motor_measure[MOTOR_INDEX_VTM_PITCH].offset_ecd = motor_measure[MOTOR_INDEX_VTM_PITCH].ecd;
	...
	if (vtm_gimbal.fVtmGimbalPowerEnabled)
	{
		...
		vtm_gimbal.yaw_current_cmd = PID_calc_with_dot_filter(&vtm_gimbal.yaw_ecd_pid, motor_measure[MOTOR_INDEX_VTM_YAW].feedback_abs_ecd_fp32, vtm_gimbal.yaw_target_ecd, vtm_yaw_error_dot_filter_coeff);
		vtm_gimbal.pitch_current_cmd = PID_calc_with_dot_filter(&vtm_gimbal.pitch_ecd_pid, motor_measure[MOTOR_INDEX_VTM_PITCH].feedback_abs_ecd_fp32, vtm_gimbal.pitch_target_ecd, vtm_pitch_error_dot_filter_coeff);
	}
}
...
static void chassis_init(chassis_move_t *chassis_move_init)
{
	...
	motor_measure[MOTOR_INDEX_VTM_PITCH].offset_ecd = 0;
	motor_measure[MOTOR_INDEX_VTM_YAW].offset_ecd = 0;
