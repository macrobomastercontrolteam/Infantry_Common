...
bool_t gpio_cmd_pitch_forward(void)
{
    return !(HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_13)); //inverse because the swich is normal open
    
}

bool_t gpio_cmd_pitch_backward(void)
{
