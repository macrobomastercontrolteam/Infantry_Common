...
#define FRIC_UP 1920 // 4456rpm, 14m/s
// #define FRIC_UP 1615 // 5093rpm, 16m/s
#define FRIC_DOWN 1648
#elif defined(INFANTRY_1) || defined(SENTRY_1)
#define FRIC_UP 1400
#define FRIC_DOWN 1320
#elif defined(INFANTRY_3)
#define FRIC_UP 1300 // test result on INFANTRY_3 (M2305 snail motor): slightly below 15m/s
#define FRIC_DOWN 1320
#endif
