...
extern void BMI088_temperature_read_over(uint8_t *rx_buf, fp32 *temperature);
extern void BMI088_read(fp32 gyro[3], fp32 accel[3], fp32 *temperature);
extern uint32_t get_BMI088_sensor_time(void);
extern fp32 get_BMI088_temperature(void);
